...
export default memo(function PrivacyPolicy() {
	return (
		<Text>
			...
			<Text>
				Leaftail1880 built the XDnevnik app as an Open Source app. This SERVICE
			...
			<Text>
				...
				Terms and Conditions, which are accessible at XDnevnik unless otherwise
			...
			<Text>
				...
				but not limited to IP, device name, device OS, device API version.. The
			...
			<Text>
				...
				hesitate to contact me at leaftail1880@outlook.com.
			</Text>{' '}
			<Text>
