	...
	return (
		<ScrollView contentContainerStyle={{ flex: 1, padding: Spacings.s2 }}>
			...
			<Text>
				...
				Wi-Fi or provided by your mobile network provider, but Leaftail1880
			...
			<Text>
				...
				(and for any additional systems we decide to extend the availability of
				the app to) may change, and you’ll need to download the updates if you
				want to keep using the app. Leaftail1880 does not promise that it will
